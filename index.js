...
app.post("/ebay-list", async (req, res) => {
  ...
  try {
    ...
    // Step 2 — Get merchant location (or use default)
    // Step 3 — Create offer
    const offerPayload = {
      sku: listingSku,
      ...
      format: "FIXED_PRICE",
      availableQuantity: 1,
      categoryId: "15032", // Film Cameras — broad default; can be refined per listing
...
// ── eBay Business Policies — fetch fulfillment/payment/return policy IDs ──────
// Call this once to get your policy IDs and set them as Railway variables:
